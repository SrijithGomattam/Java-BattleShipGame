...
/**
 * Represents tests for the ReportDamageHandler
 */
public class ReportDamageHandlerTest {
  ...
  public void testGetMessageJson() {
    ...
    assertEquals(new MessageJson("report-damage", resultNode),
        reportDamageHandler.getMessageJson(serverNode, ap));
    ...
    IllegalArgumentException e = assertThrows(IllegalArgumentException.class,
        () -> reportDamageHandler.getMessageJson(invalid, ap));
